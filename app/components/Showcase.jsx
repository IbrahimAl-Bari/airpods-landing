    ...
    return (
        <section>
            ...
            <div ref={showcaseRef} className={"h-screen w-screen flex"}>
                ...
                <div ref={airpodsref} className={"w-screen h-screen absolute z-50"}>
                ...
                <div className={"w-[50%] h-full grid grid-rows-3 grid-cols-1 ml-5"}>

                    <div ref={div1} className={"flex justify-center items-center gap-5 w-[50%]"}>
                        <Image src={"/sound.svg"} alt={"sound"} width={50} height={50}/>
                        <h3 className={"h3-base"}><span className={"h3-semibold"}>World&#39;s Best ANC</span> — Removes up to 2x more noise than AirPods Pro 2.</h3>
                    </div>

                    <div ref={div2} className={"flex justify-center items-center gap-5 w-[50%]"}>
                        <Image src={"/bass.svg"} alt={"bass"} width={50} height={50}/>
                        <h3 className={"h3-base"}><span className={"h3-semibold"}>New Acoustic Architecture</span> — deeper bass, wider soundstage.</h3>
                    </div>

                    <div ref={div3} className={"flex justify-center items-center gap-5 w-[50%]"}>
                        <Image src={"/battery.svg"} alt={"battery"} width={50} height={50}/>
                        <h3 className={"h3-base"}><span className={"h3-semibold"}>Extended Battery Life</span> — Up to 8 hours with ANC enabled.</h3>
                    </div>

                </div>


                <div className={"w-[50%] h-full grid grid-rows-3 grid-cols-1 mr-5"}>

                    <div ref={div4} className={"flex justify-end items-center w-[50%] gap-5 ml-auto"}>
                        <Image src={"/heart.svg"} alt={"heart"} width={50} height={50}/>
                        <h3 className={"h3-base"}><span className={"h3-semibold"}>Heart Rate Sensing</span> — Apple&#39;s smallest custom-built heart rate sensor.</h3>
                    </div>

                    <div ref={div5} className={"flex justify-end items-center gap-5 w-[50%] ml-auto"}>
                        <Image src={"/water.svg"} alt={"water"} width={50} height={50}/>
                        <h3 className={"h3-base"}><span className={"h3-semibold"}>IP57 Water Resistance</span> — built for intense workouts and downpours.</h3>
                    </div>

                    <div ref={div6} className={"flex justify-end items-center gap-5 w-[50%] ml-auto"}>
                        <Image src={"/aid.svg"} alt={"aid"} width={50} height={50}/>
                        <h3 className={"h3-base"}><span className={"h3-semibold"}>Hearing Aid Capability</span> — For mild to moderate hearing loss.</h3>
                    </div>
